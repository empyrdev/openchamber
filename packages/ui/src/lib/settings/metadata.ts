...
export const SETTINGS_PAGE_METADATA: readonly SettingsPageMeta[] = [
  ...
  { slug: 'integrations', title: 'Integrations', group: 'general', kind: 'single', keywords: ['integration', 'discord', 'messenger', 'slack', 'telegram', 'chat', 'connect', 'plugin', 'provider', 'oauth', 'claude', 'cursor', 'command code'] },
] as const;
