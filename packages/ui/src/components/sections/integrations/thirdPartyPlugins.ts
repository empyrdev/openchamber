...
export const THIRD_PARTY_PLUGINS: readonly ThirdPartyPluginDefinition[] = [
  {
    ...
    infoKey: 'settings.integrations.thirdParty.opencodeClaude.info',
  ...
  },
  {
    ...
    infoKey: 'settings.integrations.thirdParty.opencodeCommandcode.info',
  ...
  },
  {
    ...
    infoKey: 'settings.integrations.thirdParty.opencodeCursorOauth.info',
