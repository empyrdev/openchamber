        ...
        header={(
          <div className="flex min-w-0 flex-1 items-center gap-3">
            <div className="flex size-9 shrink-0 items-center justify-center rounded-lg bg-[var(--surface-muted)]">
              <Icon name={plugin.icon} className="size-4 text-muted-foreground" />
            </div>
      ...
      >
        <div className="space-y-4">
          ...
          >
            ...
            <p className="mt-1 text-xs leading-snug text-muted-foreground">{t(plugin.infoKey)}</p>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            >
              {isPending ? <Icon name="loader-4" className="size-3.5 animate-spin" /> : null}
              {primaryLabel}
            </Button>
            {registryUnavailable ? (
              <Button
