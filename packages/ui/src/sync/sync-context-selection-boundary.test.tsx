    ...
    test(`keeps the selected transcript whole after its directory is ${mode}`, async () => {
      ...
      try {
        ...
        await act(async () => {
          ...
          store.setState({
            session: [{ id: sessionID, projectID: 'project', directory, title: sessionID, cost: 0, tokens: { input: 0, output: 0, reasoning: 0, cache: { read: 0, write: 0 } }, time: { created: 1, updated: 1 } }],
